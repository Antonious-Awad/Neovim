...
vim.wo.colorcolumn = "99999"
 ...
 vim.cmd [[highlight IndentBlanklineIndent2 guifg=#bf616a gui=nocombine]]
 vim.cmd [[highlight IndentBlanklineIndent3 guifg=#d08770 gui=nocombine]]
 vim.cmd [[highlight IndentBlanklineIndent4 guifg=#ebcb8b gui=nocombine]]
