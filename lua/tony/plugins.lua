...
return packer.startup(function(use)
 ...
 -- use {'iamcco/markdown-preview.nvim', run = 'cd app && yarn install', cmd = 'MarkdownPreview'}
  use "lewis6991/gitsigns.nvim" -- integrates git
  use "windwp/nvim-autopairs" --autopairs, integrates with both cmp and treesitter
  use "numToStr/Comment.nvim" -- Easily comment stuff
  use "lukas-reineke/indent-blankline.nvim" --adds indetation lines
 ...
 -- cmp plugins
  ...
  use "ahmedkhalf/project.nvim" -- finds projects
 ...
 -- Web dev icons + nvim tree
  use "kyazdani42/nvim-web-devicons"
  use "nvim-tree/nvim-tree.lua"

 -- Bufferline (Similar to tabs in Vscode)
